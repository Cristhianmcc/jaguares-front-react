        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mt-2 font-display text-5xl md:text-7xl uppercase">
              Mas que una <span className="text-gradient">Academia</span>
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              Somos una comunidad deportiva comprometida con el desarrollo integral de cada persona.
              Desde los mas chicos hasta los adultos, ofrecemos programas adaptados a cada nivel y objetivo.
            </p>
            <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
              Nuestro equipo de profesionales certificados te acompana en cada paso,
              combinando tecnica, disciplina y pasion por el deporte.
            </p>
          </motion.div>
