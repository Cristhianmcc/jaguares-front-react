        ...
        <div class="max-w-screen-2xl mx-auto">
            ...
            <div id="dashboardContainer" class="hidden space-y-8">
                    ...
                    <div class="bg-white dark:bg-surface-dark p-6 rounded-xl shadow-md border-l-4 border-amber-600">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-xs text-text-muted mt-2">Cobro �nico por deporte</p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-surface-dark p-6 rounded-xl shadow-md">
                        <h3 class="text-xl font-bold text-black dark:text-white mb-6 uppercase tracking-tight">Distribuci�n de Ingresos</h3>
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl p-6 shadow-xl">
                    <h3 class="text-xl font-bold text-black dark:text-white mb-6 uppercase tracking-tight">Historial de Recaudaci�n por Mes y Deporte</h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b-2 border-primary">
                                    <th class="px-4 py-3 text-left text-xs font-bold text-text-muted dark:text-gray-400 uppercase tracking-wider">Mes / A�o</th>
    ...
    <footer class="bg-surface-light dark:bg-surface-dark border-t border-border-color py-6 mt-12">
        <div class="text-center">
            ...
            <p class="text-xs text-text-muted dark:text-gray-500 mt-1">
                �ltima actualizaci�n: <span id="timestampActualizacion">-</span>
            </p>
        </div>
    </footer>
`;
...
function loadScript(src) {
  return new Promise((resolve, reject) => {
    ...
    script.onload = () => resolve(true); // reci�n cargado
